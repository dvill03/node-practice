...
const book_list = asyncHandler(async (req, res) => {
	const allBooks = await Book.find({}, 'title author').sort({ title: 1 }).populate('author').exec()
	res.render('lists/book_list', { title: 'Book List', book_list: allBooks })
})
...
const book_create_get = asyncHandler(async (req, res) => {
...
const book_delete_get = asyncHandler(async (req, res) => {
	res.send('NOT IMPLEMENTED: Book delete GET')
})

// Handle book delete on POST.
const book_delete_post = asyncHandler(async (req, res) => {
